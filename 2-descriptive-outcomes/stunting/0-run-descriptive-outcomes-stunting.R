...
source(here("2-descriptive-outcomes/stunting/9_stunt_calc_outcomes_no_Kenaba_birth.R"))
...
source(here("2-descriptive-outcomes/stunting/12_stunt_calc_outcomes_country_strat.R"))
source(here("2-descriptive-outcomes/stunting/13_stunt_calc_outcomes_birth_strat.R"))
source(here("2-descriptive-outcomes/stunting/14_stunt_calc_stunt_timing_among_stunted.R"))
